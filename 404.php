...
function showLogin()
{
    global $name;
     ...
     {
        echo '   <ul class="menu">
		        <li><a href="customer-account.php">Welcome <span class="red">'.$name.'</span></a>
				</li>
	...
	function LiveResult(str)
{
   ...
   if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("livesearchResult").innerHTML=xmlhttp.responseText;
    document.getElementById("livesearchResult").style.border="1px solid #A5ACB2";
    }
    }
...
">Category - sidebar left</a>
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="cart.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm"><?php echo writeShoppingCart1();?></span></a>
                </div>
                <!--/.nav-collapse -->
            ...
            <div class="collapse clearfix" id="search">
                ...
                <form class="navbar-form" role="search" action="SearchResult.php" method="POST">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search"  name="livesearch" id="livesearch" onKeyUp="LiveResult(this.value)">
			...
			<button type="submit" class="btn btn-primary"><i class="fa fa-search"></i></button>
                    ...
                    <div id="livesearchResult" style="align:left"></div>
                </form>
